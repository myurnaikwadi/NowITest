...
import com.nowitest.adapter.SyllabusListAdapter;
...
public class SyllabusActivity extends ParentActivity {

    private RecyclerView activity_notification_recycler_view;
    private SyllabusListAdapter subjectListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBarCustomWithoutBack(getString(R.string.actionbarTitleSyllabus));
        findViewByIds();
        databaseHelper = new DatabaseHelper(getApplicationContext());
        syllabusItemArrayList = new ArrayList<SyllabusItem>();
        ...
        activity_notification_recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(getApplicationContext(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                ...
                Intent intent = new Intent(getApplicationContext(), SyllabusPdfActivity.class);
                intent.putExtra(Constants.syllabus_id, syllabusItemArrayList.get(position).getSyllabus_id());
    ...
    protected void onResume() {
        ...
        syllabusItemArrayList = databaseHelper.getAllSyllabus();

        subjectListAdapter = new SyllabusListAdapter(getApplicationContext(),syllabusItemArrayList);
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getApplicationContext());
        linearLayoutManager.setOrientation(LinearLayout.VERTICAL);
        activity_notification_recycler_view.setLayoutManager(linearLayoutManager);
        activity_notification_recycler_view.setAdapter(subjectListAdapter);
    ...
    public boolean syncData()
    {
        ...
        final ProgressDialog dialog = new ProgressDialog(SyllabusActivity.this);
