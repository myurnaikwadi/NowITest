...
import com.nowitest.adapter.SubjectListAdapter;
...
public class CourseActivity extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBarCustomWithoutBack(getString(R.string.actionbarTitleCourse));
        findViewByIds();
        ...
        activity_notification_recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(getApplicationContext(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                ...
                intent.putExtra(Constants.subject_id, subjectItemArrayList.get(position).getSubjectId());
    ...
    protected void onResume() {
        ...
        subjectItemArrayList.clear();
        subjectItemArrayList = databaseHelper.getAllSubject();

        subjectListAdapter = new SubjectListAdapter(getApplicationContext(),subjectItemArrayList);
...
//        }
    ...
    public boolean syncData()
    {
        ...
        final ProgressDialog dialog = new ProgressDialog(CourseActivity.this);
