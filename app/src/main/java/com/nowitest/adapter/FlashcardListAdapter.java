...
public class FlashcardListAdapter extends RecyclerView.Adapter<FlashcardListAdapter.MyViewHolder> {

    private ArrayList<FlashcardItem> flashcardItemArrayList;
    ...
    public FlashcardListAdapter(Context context, ArrayList<FlashcardItem> flashcardItemArrayList) {
        this.flashcardItemArrayList = flashcardItemArrayList;
    ...
    {
        FlashcardItem issueItem= flashcardItemArrayList.get(position);
        holder.item_list_notice_center_textview_description.setText(issueItem.getTitle());
    }

    @Override
    public int getItemCount() {
        return flashcardItemArrayList.size();
    }
}