...
//        ((AppCompatActivity) getActivity()).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new StudentLoginFragment(), getString(R.string.tab_student));
        adapter.addFrag(new AdminLoginFragment(), getString(R.string.tab_admin));
    ...
    private void setupTabs() {
        ...
        tabOne1.setText(getString(R.string.tab_student));
        ...
        tabTwo1.setText(getString(R.string.tab_admin));
